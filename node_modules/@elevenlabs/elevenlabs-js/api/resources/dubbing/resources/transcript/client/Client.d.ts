...
export declare class Transcript {
     ...
     */
    getTranscriptForDub(dubbingId: string, languageCode: string, request?: ElevenLabs.dubbing.TranscriptGetTranscriptForDubRequest, requestOptions?: Transcript.RequestOptions): core.HttpResponsePromise<string>;

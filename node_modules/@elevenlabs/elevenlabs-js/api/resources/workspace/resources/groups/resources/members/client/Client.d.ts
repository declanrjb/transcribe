...
export declare class Members {
     ...
     *     })
     */
    remove(groupId: string, request: ElevenLabs.workspace.groups.BodyDeleteMemberFromUserGroupV1WorkspaceGroupsGroupIdMembersRemovePost, requestOptions?: Members.RequestOptions): core.HttpResponsePromise<ElevenLabs.DeleteWorkspaceGroupMemberResponseModel>;
    private __remove;
    /**
     ...
     *     })
     */
    add(groupId: string, request: ElevenLabs.workspace.groups.AddMemberToGroupRequest, requestOptions?: Members.RequestOptions): core.HttpResponsePromise<ElevenLabs.AddWorkspaceGroupMemberResponseModel>;
    private __add;
}

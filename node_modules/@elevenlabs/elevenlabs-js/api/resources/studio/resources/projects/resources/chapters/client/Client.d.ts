 ...
 */
import * as environments from "@elevenlabs/elevenlabs-js/environments";
import * as core from "@elevenlabs/elevenlabs-js/core";
import * as ElevenLabs from "@elevenlabs/elevenlabs-js/api";
import { Snapshots } from "@elevenlabs/elevenlabs-js/api/resources/studio/resources/projects/resources/chapters/resources/snapshots/client/Client";
...
export declare class Chapters {
     ...
     */
    list(projectId: string, requestOptions?: Chapters.RequestOptions): core.HttpResponsePromise<ElevenLabs.GetChaptersResponse>;
    private __list;
    /**
     ...
     *     })
     */
    create(projectId: string, request: ElevenLabs.studio.projects.BodyCreateChapterV1StudioProjectsProjectIdChaptersPost, requestOptions?: Chapters.RequestOptions): core.HttpResponsePromise<ElevenLabs.AddChapterResponseModel>;
    private __create;
    /**
     ...
     */
    get(projectId: string, chapterId: string, requestOptions?: Chapters.RequestOptions): core.HttpResponsePromise<ElevenLabs.ChapterWithContentResponseModel>;
    private __get;
    /**
     * Updates a chapter.
     *
     ...
     */
    update(projectId: string, chapterId: string, request?: ElevenLabs.studio.projects.BodyUpdateChapterV1StudioProjectsProjectIdChaptersChapterIdPost, requestOptions?: Chapters.RequestOptions): core.HttpResponsePromise<ElevenLabs.EditChapterResponseModel>;
    private __update;
    /**
     * Deletes a chapter.
     *
     ...
     */
    delete(projectId: string, chapterId: string, requestOptions?: Chapters.RequestOptions): core.HttpResponsePromise<ElevenLabs.DeleteChapterResponseModel>;
    private __delete;
    /**
     ...
     */
    convert(projectId: string, chapterId: string, requestOptions?: Chapters.RequestOptions): core.HttpResponsePromise<ElevenLabs.ConvertChapterResponseModel>;
    private __convert;
}

...
export declare class Snapshots {
     ...
     */
    list(projectId: string, chapterId: string, requestOptions?: Snapshots.RequestOptions): core.HttpResponsePromise<ElevenLabs.ChapterSnapshotsResponse>;
    private __list;
    /**
     ...
     */
    get(projectId: string, chapterId: string, chapterSnapshotId: string, requestOptions?: Snapshots.RequestOptions): core.HttpResponsePromise<ElevenLabs.ChapterSnapshotExtendedResponseModel>;
    private __get;
    /**
     ...
     * @throws {@link ElevenLabs.UnprocessableEntityError}
     */
    stream(projectId: string, chapterId: string, chapterSnapshotId: string, request?: ElevenLabs.studio.projects.chapters.BodyStreamChapterAudioV1StudioProjectsProjectIdChaptersChapterIdSnapshotsChapterSnapshotIdStreamPost, requestOptions?: Snapshots.RequestOptions): core.HttpResponsePromise<stream.Readable>;
    private __stream;
}

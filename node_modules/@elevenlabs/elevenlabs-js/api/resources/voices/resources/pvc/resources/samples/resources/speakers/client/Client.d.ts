...
import { Audio } from "@elevenlabs/elevenlabs-js/api/resources/voices/resources/pvc/resources/samples/resources/speakers/resources/audio/client/Client";
...
export declare class Speakers {
     ...
     */
    get(voiceId: string, sampleId: string, requestOptions?: Speakers.RequestOptions): core.HttpResponsePromise<ElevenLabs.SpeakerSeparationResponseModel>;
    private __get;
    /**
     ...
     */
    separate(voiceId: string, sampleId: string, requestOptions?: Speakers.RequestOptions): core.HttpResponsePromise<ElevenLabs.StartSpeakerSeparationResponseModel>;
    private __separate;
}

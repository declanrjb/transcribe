import { BaseSchema, Schema, inferParsed, inferRaw } from "@elevenlabs/elevenlabs-js/core/schemas/Schema";
import { addQuestionMarksToNullableProperties } from "@elevenlabs/elevenlabs-js/core/schemas/utils/addQuestionMarksToNullableProperties";
import { ObjectLikeUtils } from "@elevenlabs/elevenlabs-js/core/schemas/builders/object-like";
import { SchemaUtils } from "@elevenlabs/elevenlabs-js/core/schemas/builders/schema-utils";
import { Property } from "@elevenlabs/elevenlabs-js/core/schemas/builders/object/property";
